...
import com.solace.labs.cardemo.controller.iot.IoTActionListener;
...
//                iotClient.subscribeToCommand("+", "json", 0, "subscribe", listener);
                // controller subscribes to events and publishes commands
                iotClient.subscribeToEvent("+", "json", 0, "subscribe", listener);
            } catch (MqttException e) {
                Log.d(TAG, ".handleConnectSuccess() received exception on subscribeToEvent()");
            }
