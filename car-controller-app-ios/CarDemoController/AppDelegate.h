...
@property (strong, nonatomic) CarDemoControllerViewController *carDemoControllerViewController;
...
@property (strong, nonatomic) NSString *routerAddress;
...
@property (atomic) CLLocationCoordinate2D latestLocation;
