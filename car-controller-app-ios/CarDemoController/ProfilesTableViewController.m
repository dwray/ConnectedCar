...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    AppDelegate *appDelegate =(AppDelegate *) [[UIApplication sharedApplication] delegate];
    IoTProfile *profile = [[IoTProfile alloc] initWithName:[alertView textFieldAtIndex:0].text routerAddress:self.currentRouterAddress userName:self.currentUserName password:self.currentPassword];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    appDelegate.userName = profile.userName;
    appDelegate.routerAddress = profile.routerAddress;
    appDelegate.password = profile.password;
