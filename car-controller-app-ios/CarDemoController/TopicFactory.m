 ...
 */
+ (NSString *)getEventTopic:(NSString *)event VIN:(NSString *)VIN
{
    NSString *topicString = [NSString stringWithFormat:IOTEventTopic, VIN, event, @"json"];
    return topicString;
}
 ...
 */
+ (NSString *)getCommandTopic:(NSString *)command VIN:(NSString *)VIN
{
    NSString *topicString = [NSString stringWithFormat:IOTCommandTopic, VIN, command, @"json"];
    return topicString;
}
