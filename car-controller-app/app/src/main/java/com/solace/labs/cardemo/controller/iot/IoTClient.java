...
public class IoTClient {
    ...
    private IoTClient(Context context, String organization, String deviceID, String deviceType, String authorizationToken, String VIN) {
        this.context = context;
        this.client = null;
     ...
     * @return The IoTClient object for the application
     */
    public static IoTClient getInstance(Context context, String organization, String deviceID, String deviceType, String authorizationToken, String VIN) {
        Log.d(TAG, ".getInstance() entered");
        if (instance == null) {
            instance = new IoTClient(context, organization, deviceID, deviceType, authorizationToken, VIN);
        } else {
...
//
//            client = new MqttAndroidClient(context, connectionURI, MqttClient.generateClientId(), dataStore, MqttAndroidClient.Ack.AUTO_ACK);
            String tmpDir = System.getProperty("java.io.tmpdir");
            MqttDefaultFilePersistence dataStore = new MqttDefaultFilePersistence(tmpDir);

            client = new MqttAndroidClient(context, connectionURI, MqttClient.generateClientId(), MqttAndroidClient.Ack.AUTO_ACK);
