...
import com.solace.labs.cardemo.sensor.iot.IoTDevice;
...
import com.solace.labs.cardemo.sensor.utils.MyIoTCallbacks;
...
public class IoTStarterApplication extends Application {
    ...
    // don't show tutorial by default on the sensor as it interferes with the permissions request dialog
                    ...
                    try {
                        ...
                        if ((profile = settings.getStringSet(key, null)) != null) {
                            ...
                            if (newProfile.getDeviceName().equals(profileName)) {
                                ...
                                this.setGLevel(newProfile.getGLevel());
                            }
                        }
                    } catch (Exception e) {
