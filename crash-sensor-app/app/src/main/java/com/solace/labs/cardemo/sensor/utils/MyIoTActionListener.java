...
import com.solace.labs.cardemo.sensor.iot.IoTActionListener;
...
public class MyIoTActionListener implements IoTActionListener {
    ...
    private void handleConnectSuccess() {
        ...
        try {
            ...
            // sensor subscribes to commands and publishes events
            // color events QoS1 to show offline delivery
            iotClient.subscribeToCommand(Constants.COLOR_COMMAND, "json", 1, "subscribe", listener);
            iotClient.subscribeToCommand(Constants.ENGINE_COMMAND, "json", 0, "subscribe", listener);
            iotClient.subscribeToCommand(Constants.HORN_COMMAND, "json", 0, "subscribe", listener);
            iotClient.subscribeToCommand(Constants.LOCK_COMMAND, "json", 0, "subscribe", listener);
            iotClient.subscribeToCommand(Constants.LIGHT_COMMAND, "json", 0, "subscribe", listener);
    ...
    private void handleConnectFailure(Throwable throwable) {
        ...
        String errMsg = "Failed to connect to Solace Router: "+NL+throwable;
